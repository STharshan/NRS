...
const AboutSection = () => {
  ...
  const testimonials = [
  {
    text: "Amazing service from Richard. Super easy to get along with and transparent from start to finish. Called on Monday about my car and came out and did the job with two days notice. It’s like new car day, power and acceleration gain is really noticeable and I’m so so happy. Car puts a smile on my face. Would highly recommend to anyone, couldn’t recommend a better place for a remap.",
    name: "Owen James",
  },
